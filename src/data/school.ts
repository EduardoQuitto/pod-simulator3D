...
export const WALLS: WallDef[] = [
  ...
  // Parede OESTE (antes da porta do banheiro z:-4.5..-2.5)
  { position: [-2, 1.5, -12.25], size: [0.25, 3.2, 15.5], color: W },
  // Parede OESTE (depois da porta banheiro z:-1.5..2.5)
  { position: [-2, 1.5, 0.5], size: [0.25, 3.2, 4], color: W },
  // Parede OESTE (porta academia z:5.5..7.5)
  { position: [-2, 1.5, 10], size: [0.25, 3.2, 9], color: W },

  // Parede LESTE (portas salas)
  { position: [2, 1.5, -17.875], size: [0.25, 3.2, 4.25], color: W },
  { position: [2, 1.5, -13], size: [0.25, 3.2, 3.5], color: W },
  { position: [2, 1.5, -7.75], size: [0.25, 3.2, 5.5], color: W },
  { position: [2, 1.5, -1], size: [0.25, 3.2, 5], color: W },
  { position: [2, 1.5, 5.5], size: [0.25, 3.2, 5], color: W },
  { position: [2, 1.5, 12.25], size: [0.25, 3.2, 5.5], color: W },
  { position: [2, 1.5, 18.25], size: [0.25, 3.2, 3.5], color: W },

  // Parede SUL (entrada)
  { position: [-1.5, 1.5, -20], size: [1, 3.2, 0.25], color: W },
  { position: [1.5, 1.5, -20], size: [1, 3.2, 0.25], color: W },
  // Parede SUL adicionais (lados da entrada)
  ...
  { position: [3, 1.5, 26], size: [0.25, 3.2, 8], color: W },
...
export const FURNITURE: FurnitureDef[] = [
  ...
  { type: 'chair', position: [4, 0.3, -11.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [6, 0.4, -12.5], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [6, 0.3, -11.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [8, 0.4, -12.5], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [8, 0.3, -11.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [4, 0.4, -11.5], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [4, 0.3, -11], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [6, 0.4, -11.5], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [6, 0.3, -11], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [8, 0.4, -11.5], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [8, 0.3, -11], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  ...
  { type: 'chair', position: [4, 0.3, -5.3], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [6, 0.4, -6], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [6, 0.3, -5.3], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [8, 0.4, -6], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [8, 0.3, -5.3], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  ...
  { type: 'chair', position: [4, 0.3, 3.7], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [6, 0.4, 3], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [6, 0.3, 3.7], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'desk', position: [8, 0.4, 3], size: [1.2, 0.8, 0.8], color: '#8B6914' },
  { type: 'chair', position: [8, 0.3, 3.7], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  ...
  // ═══════ CORREDOR - Armários ═══════
  { type: 'locker', position: [-1.7, 0.8, -16], size: [0.4, 1.6, 0.6], color: '#607080' },
  { type: 'locker', position: [-1.7, 0.8, -15], size: [0.4, 1.6, 0.6], color: '#607080' },
  { type: 'locker', position: [-1.7, 0.8, -14], size: [0.4, 1.6, 0.6], color: '#607080' },
  { type: 'locker', position: [-1.7, 0.8, -10], size: [0.4, 1.6, 0.6], color: '#5a6a7a' },
  { type: 'locker', position: [-1.7, 0.8, -9], size: [0.4, 1.6, 0.6], color: '#5a6a7a' },
  { type: 'locker', position: [-1.7, 0.8, 3], size: [0.4, 1.6, 0.6], color: '#607080' },
  { type: 'locker', position: [-1.7, 0.8, 4], size: [0.4, 1.6, 0.6], color: '#607080' },
  { type: 'locker', position: [-1.7, 0.8, 12], size: [0.4, 1.6, 0.6], color: '#5a6a7a' },
  { type: 'locker', position: [-1.7, 0.8, 13], size: [0.4, 1.6, 0.6], color: '#5a6a7a' },
  { type: 'locker', position: [-1.7, 0.8, 14], size: [0.4, 1.6, 0.6], color: '#5a6a7a' },

  // ═══════ CORREDOR - Máquina de vendas ═══════
  { type: 'vending', position: [1.7, 0.9, -10], size: [0.6, 1.8, 0.8], color: '#3a4a5a' },

  // ═══════ BANHEIRO ═══════
  { type: 'stall', position: [-6, 0.8, -4], size: [1.2, 1.6, 0.8], color: '#c0c0c0' },
  { type: 'stall', position: [-4.5, 0.8, -4], size: [1.2, 1.6, 0.8], color: '#c0c0c0' },
  { type: 'stall', position: [-3.5, 0.8, -4], size: [1.2, 1.6, 0.8], color: '#c0c0c0' },
  { type: 'sink', position: [-3.5, 0.6, -1.8], size: [0.6, 1.2, 0.4], color: '#e0e0e0' },
  { type: 'sink', position: [-5, 0.6, -1.8], size: [0.6, 1.2, 0.4], color: '#e0e0e0' },

  // ═══════ ACADEMIA ═══════
  { type: 'bench', position: [-12, 0.25, 6], size: [3, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [-12, 0.25, 13], size: [3, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [-9.5, 0.25, 9.5], size: [0.6, 0.5, 3], color: '#6b4226' },
  ...
  { type: 'chair', position: [5, 0.3, 24.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'chair', position: [8, 0.3, 24.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'chair', position: [5, 0.3, 28.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'chair', position: [8, 0.3, 28.8], size: [0.5, 0.6, 0.5], color: '#A0722D' },
  { type: 'locker', position: [3.3, 0.8, 24], size: [0.4, 1.6, 0.6], color: '#5a3a20' },
  { type: 'locker', position: [3.3, 0.8, 25], size: [0.4, 1.6, 0.6], color: '#5a3a20' },
  { type: 'locker', position: [3.3, 0.8, 26], size: [0.4, 1.6, 0.6], color: '#5a3a20' },
  { type: 'locker', position: [9.7, 0.8, 24], size: [0.4, 1.6, 0.6], color: '#5a3a20' },
  { type: 'locker', position: [9.7, 0.8, 25], size: [0.4, 1.6, 0.6], color: '#5a3a20' },
  { type: 'locker', position: [9.7, 0.8, 26], size: [0.4, 1.6, 0.6], color: '#5a3a20' },

  // ═══════ PÁTIO ═══════
  { type: 'bench', position: [-4, 0.25, 24], size: [2, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [4, 0.25, 24], size: [2, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [0, 0.25, 28], size: [2, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [-4, 0.25, 30], size: [2, 0.5, 0.6], color: '#6b4226' },
  { type: 'bench', position: [4, 0.25, 30], size: [2, 0.5, 0.6], color: '#6b4226' },
  { type: 'tree', position: [-5, 0, 26], color: '#4a7a3a' },
  { type: 'tree', position: [5, 0, 27], color: '#3a6a2a' },
  { type: 'tree', position: [-3, 0, 30], color: '#4a8a3a' },
  { type: 'tree', position: [3, 0, 29], color: '#3a7a2a' },
  { type: 'trashCan', position: [0, 0.4, 22], size: [0.4, 0.8, 0.4], color: '#4a5a4a' },

  // ═══════ CORREDOR - Lixeiras e lixeiras ═══════
  { type: 'trashCan', position: [1.7, 0.4, 15], size: [0.4, 0.8, 0.4], color: '#4a5a4a' },
  { type: 'trashCan', position: [-1.7, 0.4, -18], size: [0.4, 0.8, 0.4], color: '#4a5a4a' },
];
...
export const INTERACTIVE_OBJECTS: InteractiveObjectDef[] = [
  { id: 'pod_bathroom', name: 'Pod escondido', type: 'pod', position: [-7, 0.8, -2.5], size: [0.15, 0.3, 0.1], color: '#8a8a9a' },
  { id: 'backpack', name: 'Sua mochila', type: 'backpack', position: [4, 0.3, -12], size: [0.4, 0.5, 0.3], color: '#3a5a8a' },
  { id: 'vending', name: 'Máquina de vendas', type: 'vending', position: [1.7, 0.9, -10], size: [0.6, 1.8, 0.8], color: '#3a4a5a' },
  { id: 'phone', name: 'Celular', type: 'phone', position: [6, 0.85, -13.8], size: [0.15, 0.02, 0.08], color: '#1a1a2a' },
  { id: 'pod_courtyard', name: 'Pod no chão', type: 'pod', position: [1, 0.05, 28], size: [0.15, 0.3, 0.1], color: '#7a7a8a' },
  { id: 'book', name: 'Livro na estante', type: 'backpack', position: [3.5, 1, 25], size: [0.2, 0.3, 0.15], color: '#8a3a3a' },
];
