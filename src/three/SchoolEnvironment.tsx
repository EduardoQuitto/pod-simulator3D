  ...
  return (
    <group>
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.01, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#3a3835" roughness={0.85} metalness={0.01} />
      </mesh>
      {tiles}
    </group>
  );
      ...
      l.push(
        <group key={`cl-${z}`}>
          <mesh position={[0, 3.18, z]}>
            ...
            <meshStandardMaterial color="#ffffff" emissive="#fff8e8" emissiveIntensity={1.5} roughness={0.3} />
          </mesh>
          <mesh position={[0, 3.22, z]}>
            <boxGeometry args={[0.35, 0.02, 2.1]} />
            <meshStandardMaterial color="#e8e4e0" metalness={0.4} roughness={0.3} />
          </mesh>
  ...
  return (
    <group>
      <mesh rotation={[Math.PI / 2, 0, 0]} position={[0, 3.25, 0]} receiveShadow>
        <planeGeometry args={[60, 70]} />
        <meshStandardMaterial color="#e8e4e0" roughness={0.9} metalness={0.0} />
      </mesh>
      {lights}
    </group>
  );
  ...
  return (
    <group>
      <mesh position={position} castShadow receiveShadow>
        ...
        <meshStandardMaterial color={color} roughness={0.82} metalness={0.01} envMapIntensity={0.2} />
      </mesh>
      <mesh position={[position[0], 0.08, position[2]]}>
        <boxGeometry args={[size[0] + 0.02, 0.16, size[2] + 0.02]} />
        <meshStandardMaterial color="#c0b8a8" roughness={0.65} metalness={0.02} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh position={[0, 0.3, 0]} castShadow>
        ...
        <meshStandardMaterial color="#A0722D" roughness={0.6} metalness={0.05} />
      </mesh>
  ...
  return (
    <group position={position}>
      <mesh position={[0, 0, -0.06]} castShadow>
        ...
        <meshStandardMaterial color="#4a2a15" roughness={0.75} metalness={0.05} />
      </mesh>
      <mesh castShadow>
        <boxGeometry args={size} />
        <meshStandardMaterial color="#2a4a22" roughness={0.4} metalness={0.0} envMapIntensity={0.15} />
      </mesh>
      <mesh position={[0, -size[1]/2 - 0.02, 0.06]}>
        <boxGeometry args={[size[0] * 0.6, 0.06, 0.12]} />
        <meshStandardMaterial color="#d0c8b0" roughness={0.55} metalness={0.1} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color={color} roughness={0.35} metalness={0.45} envMapIntensity={0.6} />
      </mesh>
      <mesh position={[0, 0, 0.31]}>
        <boxGeometry args={[0.36, 1.52, 0.01]} />
        <meshStandardMaterial color={new THREE.Color(color).multiplyScalar(0.85)} roughness={0.3} metalness={0.5} envMapIntensity={0.7} />
      </mesh>
  ...
  return (
    <group position={position}>
      <mesh position={[0, 0.9, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#2a3a4a" roughness={0.25} metalness={0.35} envMapIntensity={0.8} />
      </mesh>
      <mesh position={[0, 1.2, 0.41]}>
        <boxGeometry args={[0.4, 0.8, 0.02]} />
        <meshStandardMaterial color="#0a1520" roughness={0.05} metalness={0.1} />
      </mesh>
      ...
      <mesh position={[0, 0.4, 0.41]}>
        ...
        <meshStandardMaterial color="#1a2a3a" metalness={0.3} roughness={0.4} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh position={[0, 0.4, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#6b4226" roughness={0.65} metalness={0.03} envMapIntensity={0.3} />
      </mesh>
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, 3.5, 0]} castShadow>
        ...
        <meshStandardMaterial color="#2a6a1a" roughness={0.85} metalness={0.0} />
      </mesh>
  ...
  return (
    <group position={position}>
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#b8b8b8" roughness={0.35} metalness={0.2} envMapIntensity={0.5} />
      </mesh>
  ...
  return (
    <group position={position}>
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#e0e0e0" roughness={0.2} metalness={0.35} envMapIntensity={0.6} />
      </mesh>
      <mesh position={[0, 0.6, 0.21]}>
        <cylinderGeometry args={[0.04, 0.04, 0.15, 8]} />
        <meshStandardMaterial color="#c0c0c0" metalness={0.75} roughness={0.15} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh position={[0, 0.4, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#3a4a3a" roughness={0.65} metalness={0.15} />
      </mesh>
      <mesh position={[0, 0.82, 0]}>
        <cylinderGeometry args={[0.22, 0.22, 0.04, 12]} />
        <meshStandardMaterial color="#2a3a2a" roughness={0.5} metalness={0.25} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position} rotation={rotation}>
      <mesh>
        ...
        <meshStandardMaterial color="#d0ccc5" roughness={0.6} metalness={0.02} />
      </mesh>
      ...
      <mesh position={[0, 0, 0.07]}>
        ...
        <meshStandardMaterial color="#d0ccc5" roughness={0.5} />
      </mesh>
      <mesh position={[0, 0, 0.07]}>
  ...
  return (
    <group position={position} rotation={rotation}>
      ...
      <mesh position={[0.55, 1.4, 0.08]}>
        ...
        <meshStandardMaterial color="#b89040" metalness={0.8} roughness={0.2} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh castShadow>
        ...
        <meshStandardMaterial color="#7a7a8a" roughness={0.3} metalness={0.5} envMapIntensity={0.8} />
      </mesh>
      <mesh position={[0, 0.15, 0]}>
        <cylinderGeometry args={[0.025, 0.035, 0.08, 10]} />
        <meshStandardMaterial color="#5a5a6a" roughness={0.25} metalness={0.6} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh castShadow>
        ...
        <meshStandardMaterial color="#2a4a7a" roughness={0.85} metalness={0.02} />
      </mesh>
      <mesh position={[0, 0.3, 0.16]}>
        <boxGeometry args={[0.2, 0.15, 0.02]} />
        <meshStandardMaterial color="#1a3a6a" roughness={0.8} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh castShadow>
        ...
        <meshStandardMaterial color="#0a0a15" roughness={0.1} metalness={0.6} envMapIntensity={0.9} />
      </mesh>
      <mesh position={[0, 0.012, 0]}>
        <boxGeometry args={[0.13, 0.005, 0.06]} />
        <meshStandardMaterial color="#2a4a8a" emissive="#2a4a8a" emissiveIntensity={0.6} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      <mesh castShadow>
        ...
        <meshStandardMaterial color="#7a2a2a" roughness={0.8} metalness={0.02} />
      </mesh>
    ...
    <>
      {labels.map((l) => (
        <mesh key={l.text} position={l.pos}>
          ...
          <meshStandardMaterial color="#3a5a7a" roughness={0.5} metalness={0.1} />
        </mesh>
      ))}
    </>
  );
